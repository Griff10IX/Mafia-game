...
export const SEARCHABLE_TOOLS = [
  ...
  { label: "User give / take & leaderboards", categoryId: "admin-players", collapseKey: "userAdjustHub", keywords: ["leaderboard","adjust","strip","username","crimes","scores","gta","busts","kills","money","points","respect","bullets","weekly","alltime","preview","partial","bootleg","racing lifetime","lifetime earnings"] },
