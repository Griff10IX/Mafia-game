...
export const ADMIN_ROUTE_GROUPS = [
  ...
  { id: 'dead-estates', label: 'Dead estates', categoryId: 'admin-economy-progression', kind: 'standalone', icon: Skull, description: 'Living players with linked dead accounts still holding points, cash, or Swiss.' },
  ...
  { id: 'bodyguard-hire-logs', label: 'BG hire logs', categoryId: 'admin-analytics-monitoring', kind: 'standalone', icon: Shield, description: 'Robot bodyguard hire attempts — rvk gate fails and legacy bot fingerprints.' },
