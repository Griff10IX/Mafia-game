...
export const ADMIN_ROUTE_GROUPS = [
  ...
  { id: 'weed-sell-audit', label: 'Weed sell audit', categoryId: 'admin-economy-progression', anchorId: 'admin-donations', icon: Leaf, description: 'Sell-spam clawback + reset all farm heat for the new heat system.' },
