...
export default function VideoPoker() {
  ...
  const handleRemoveBuyBack = async () => {
    ...
    setOwnerLoading(true);
    try {
      await removeCasinoBuyBack('videopoker', { city });
            ...
            <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-2">
              <div className="flex flex-wrap items-center gap-2 w-full">
                ...
                <FormattedNumberInput
                  ...
                  className="flex-1 min-w-[6rem] bg-zinc-900/50 border border-zinc-700/50 rounded px-2 py-1 text-xs text-foreground focus:border-primary/50 focus:outline-none"
                />
          ...
          <div className="p-3 sm:p-5">
            ...
            {!game ? (
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                {/* Initial deal: show made hand before draw */}
