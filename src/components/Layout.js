  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/leaderboard', label: 'Weekly Leaderboard' },
        { path: '/leaderboard/all-time', label: 'All-Time Leaderboard' },
...
export default function Layout({ children }) {
  ...
  const navItems = [
    ...
    { path: '/leaderboard', icon: Trophy, label: 'Weekly Leaderboard' },
    { path: '/leaderboard/all-time', icon: Trophy, label: 'All-Time Leaderboard' },
