...
export const THEME_PRESETS = [
  ...
  { id: 'modern-full', name: 'Modern Full', description: 'Modern spacing, slate-gray futuristic palette, cleaner typography and layout', colourId: 'matte-slate', textureId: 'modern-soft', buttonColourId: 'steel', accentLineColourId: 'slate', writingColourId: 'steel-text', mutedWritingColourId: 'slate-300', buttonStyleId: 'flat', fontId: 'modern', textStyleId: 'medium', toastTextColourId: 'steel-text', mobileNavStyle: 'bottom', themeVariant: 'modern', isFullPreset: true },
