...
export const THEME_VARIANTS = [
  ...
  { id: 'old_school', name: 'Old School Mafia', description: 'Classic browser chrome — damask navy canvas, silver beveled boxes, metal tab headers' },
];
...
export const THEME_PRESETS = [
  ...
  { id: 'old-school-mafia-theme', name: 'Old School Mafia Theme', description: 'Classic early-browser look: damask navy canvas, silver chrome panels, metal tab headers, blue category labels', colourId: 'steel-blue', textureId: 'crosshatch', buttonColourId: 'dark-chrome', accentLineColourId: 'brushed-silver', writingColourId: 'cool-white', mutedWritingColourId: 'chrome-text', buttonStyleId: 'flat', fontId: 'compact', textStyleId: 'normal', toastTextColourId: 'cool-white', mobileNavStyle: 'bottom', mobileStatsDisplay: 'right_sidebar', sidebarLayout: 'categorized_classic', themeVariant: 'old_school', buttonShapeId: 'sharp', isFullPreset: true, presetCategory: 'mafia' },
