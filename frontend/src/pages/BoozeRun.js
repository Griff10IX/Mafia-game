...
function HistoryRow({ h }) {
  ...
  return (
    <tr className="border-b border-primary/10 last:border-0 hover:bg-zinc-800/30 transition-smooth">
...
function BestRouteCard({ r }) {
  return (
    <div className="bg-zinc-800/50 border border-primary/20 rounded-sm p-2.5">
    ...
    <tr className="border-b border-primary/10 last:border-0 hover:bg-zinc-800/30 transition-smooth">
      ...
      <td className="py-1.5 px-2 text-right">
        ...
        <input
          ...
          className="w-12 text-right bg-zinc-800/80 border border-primary/20 rounded px-1 py-0.5 font-heading text-foreground inline focus:border-primary/50 focus:outline-none"
        />
      ...
      <td className="py-1.5 px-2 text-right space-x-1">
        ...
        <button
          ...
          className="bg-zinc-800 border border-primary/30 text-foreground hover:bg-zinc-700 px-2 py-1 rounded text-[10px] font-heading font-bold uppercase tracking-wider transition-smooth disabled:opacity-50"
        >
          Sell
        </button>
      </td>
...
export default function BoozeRun() {
  ...
  return (
    <div className="space-y-6" data-testid="booze-run-page">
      ...
      <div className="bg-gradient-to-b from-zinc-900 to-black border border-primary/30 rounded-sm px-4 py-3">
