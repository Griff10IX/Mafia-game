    ...
    async def get_me(request: Request, current_user: dict = Depends(get_current_user)):
        ...
        try:
            ...
            return UserResponse(
                ...
                has_commissioners_pardon=bool(u.get("has_commissioners_pardon")),
                ...
                cooldown_skip_crime_credits=_safe_int(u.get("cooldown_skip_crime_credits"), 0),
                cooldown_skip_gta_credits=_safe_int(u.get("cooldown_skip_gta_credits"), 0),
                cooldown_skip_booze_credits=_safe_int(u.get("cooldown_skip_booze_credits"), 0),
                cooldown_skip_properties_credits=_safe_int(u.get("cooldown_skip_properties_credits"), 0),
