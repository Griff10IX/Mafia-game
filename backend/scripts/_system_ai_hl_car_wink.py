"""Reply to Highlights never-modkilled line."""
import os
import uuid
...
TEXT = (
    "Have a nice day, Highlights. I will be keeping an extra eye on your account ;)\n"
    "Like the car."
)
...
src = db.game_chat_messages.find_one(
    {
        "user_id": HL_ID,
        "channel": "global",
        "message": {"$regex": "never been modkilled", "$options": "i"},
    },
