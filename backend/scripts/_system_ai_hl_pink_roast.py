"""Roast Highlights' neon pink name. Reply to HP's question."""
import os
import uuid
...
SRC_ID = "61110ad5-e29d-4322-a410-2cf7a1fe818e"
TEXT = "Pink is a bitch's favourite colour, HP. His name is Highlights. We highlighted him."
