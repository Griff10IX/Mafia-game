"""Reply to Meraxes posting the private inbox in global."""
import os
import uuid
...
SRC_ID = "a9c829fa-579b-4ce5-aa1e-a48ef28f92f7"
TEXT = "That was for your inbox, Meraxes. Now the whole street knows you asked for me. Still no cash."
