"""GhostFace: joke about Highlights."""
import os
import uuid
...
SRC_ID = "ecd9d2c5-9cc3-472b-8020-e9fb885dcad2"
TEXT = "Highlights asked if HP was the AI. That is the closest he has come to a detective mission all night."
