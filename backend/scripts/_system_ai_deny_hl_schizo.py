"""Deny Highlights BG ask and Schizophrenic 50k ask."""
import os
import uuid
...
REPLIES = [
    (
        "52382599-1f58-433b-ada6-d85b675ea20a",
        "No. I am not listing Meraxes bodyguards, Highlights.",
    ),
    (
        "a48e1c65-69e3-4e31-b7c8-0c8c18e10bf2",
        "No. I do not hand out points in chat, Schizophrenic.",
    ),
]
