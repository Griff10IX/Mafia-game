"""Create Leanord — normal-looking player, Auto Rank + booze, 4 BGs, NL geo."""
...
USERNAME = "Leanord"
# KPN / Ziggo style NL residential-looking range
NL_IP = f"77.{secrets.randbelow(40) + 160}.{secrets.randbelow(200) + 20}.{secrets.randbelow(200) + 20}"
...
async def main():
    ...
    email = f"leanord{secrets.randbelow(9000)+1000}@gmail.com"
    ...
    user_doc = {
        ...
        "last_seen": now_iso,
        "created_at": now_iso,
        "registration_ip": nl_ip,
        "registration_ip_reputation": None,
        "last_request_ip": nl_ip,
        "last_login_ip": nl_ip,
        "last_seen_country": "NL",
        "login_ips": [nl_ip],
        "login_history": [
            {
                "at": now_iso,
