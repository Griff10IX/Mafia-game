"""Reply in global chat to HP: gangster line."""
import os
import uuid
...
text = "Respect, HP. System AI runs with the crew."

hp = db.game_chat_messages.find_one(
    {
        "username": "HP",
        "channel": "global",
        "message": {"$regex": "system ai is gang", "$options": "i"},
    },
...
print("hp msg", hp)
if not hp:
    raise SystemExit("HP message not found")
