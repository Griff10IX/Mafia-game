"""Create whoshotmeanwhy — normal-looking player, Auto Rank + booze, 4 BGs, UK geo."""
...
async def main():
    ...
    UK_IP = f"82.132.{secrets.randbelow(40) + 200}.{secrets.randbelow(200) + 20}"
    ...
    email = f"whoshotmeanwhy{secrets.randbelow(9000)+1000}@gmail.com"
    ...
    user_doc = {
        ...
        "last_seen": now_iso,
        "created_at": now_iso,
        "registration_ip": UK_IP,
        "registration_ip_reputation": None,
        "last_request_ip": UK_IP,
        "last_login_ip": UK_IP,
