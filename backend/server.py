...
@api_router.post("/trade/sell-offer")
...
@api_router.post("/trade/buy-offer/{offer_id}/accept")
...
@api_router.post("/trade/property/{property_id}/accept")
async def buy_property(property_id: str, current_user: dict = Depends(get_current_user)):
...
from routers import crimes, gta, jail, oc, organised_crime, forum, entertainer, bullet_factory, objectives, attack, bank, families, weapons, bodyguards, airport
