...
async def qt_cash_price_per_point(db, *, min_price_per_point: float) -> tuple[bool, float, int]:
    """
    ...
    active sell offers exist; otherwise min_price_per_point floor only.
    """
