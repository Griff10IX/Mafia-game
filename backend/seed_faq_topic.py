...
• Dead/Alive: If your account is dead, use Dead > Alive from a new account to receive 95% of that account’s money and points (5% tax) once (dead account password required).
"""
